                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="col-span-1 md:col-span-2">
                            ...
                            <input
                                ...
                                className="w-full glass-input px-3 py-2 text-sm rounded-lg focus:ring-2 focus:ring-white/20"
                        ...
                        <div className="col-span-1 md:col-span-2 border-t border-white/10 pt-4">
                            <h4 className="text-sm font-semibold text-gray-300 mb-3">Custom Styling Override</h4>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
